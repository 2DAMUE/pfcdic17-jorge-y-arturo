...
public class NavActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent;
                try {
                    intent  =   builder.build(NavActivity.this);
    ...
    protected void onActivityResult( int requestCode , int resultCode , Intent data ){
        if( requestCode == PLACE_PICKER_REQUEST)
        {
            if(resultCode == RESULT_OK)
            {
                ...
                if (addresses.size() > 0)
                {
                    Direccion.setAddress(addresses.get(0));
                    Intent intent = new Intent(NavActivity.this, Direccion.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_hotel) {
            ...
            Intent i = new Intent(NavActivity.this, Direcciones.class);
            startActivity(i);
